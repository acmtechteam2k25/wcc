      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-slate-800">
          ...
          <div className="md:col-span-4">
            ...
            <h4 className="text-white font-display font-bold text-xs uppercase tracking-wider mb-2">
              Faculty Coordinator
            </h4>
            <div className="text-xs space-y-1">
              <p className="font-semibold text-slate-300">Mr. Murali Mohan Samineni</p>
              <a href="mailto:muralimohan_s@vnrvjiet.in" className="hover:text-white transition-colors">
